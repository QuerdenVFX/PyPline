...
class MyPromt(Cmd):
    ...
    def do_add(self, inp):
        import Sololearn_v001
        # self.dir = os.path.abspath(os.getcwd()+"/PROJECT DIRECTORY")

        # self.my_list = os.listdir(dir)
        # dictOfProjects = {i : None for i in self.my_list}
        ...
        #     #----------------------------------------------------------------#
        #     #                        PROJECT Data                            #
        #     Name = inquirer.text(message="Project Name :", completer={i : None for i in self.my_list}, multicolumn_complete=True).execute()
